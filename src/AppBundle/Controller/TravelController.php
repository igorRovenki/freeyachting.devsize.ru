...
class TravelController extends Controller
{
     ...
     * Search Travels
     *
     * @Route("/search", name="search_travel")
     * @Template()
     ...
     * @Method("POST")
     * @Template("AppBundle:Travel:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('travel_show', ['id' => $entity->getId()]));
        }
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Travel')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Travel:edit.html.twig")
     */
