 ...
 */
class Version20151103231755 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE travels_photos (travel_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_9EDFC752ECAB15B3 (travel_id), INDEX IDX_9EDFC7523DA5256D (image_id), PRIMARY KEY(travel_id, image_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE travels_photos ADD CONSTRAINT FK_9EDFC752ECAB15B3 FOREIGN KEY (travel_id) REFERENCES travels (id)');
        $this->addSql('ALTER TABLE travels_photos ADD CONSTRAINT FK_9EDFC7523DA5256D FOREIGN KEY (image_id) REFERENCES media__media (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE travels_photos DROP FOREIGN KEY FK_9EDFC7523DA5256D');
        $this->addSql('DROP TABLE media__gallery');
        $this->addSql('DROP TABLE media__gallery_media');
        $this->addSql('DROP TABLE media__media');
        $this->addSql('DROP TABLE travels_photos');
    }
}
